        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientMemberId = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PanelStatusId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PanelStatuses", x => x.PanelStatusId);
                    table.ForeignKey(
                        name: "FK_PanelStatuses_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId");
                    table.ForeignKey(
                        name: "FK_PanelStatuses_Managers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "Managers",
                        principalColumn: "ManagerId");
                    table.ForeignKey(
                        name: "FK_PanelStatuses_Schedules_PanelStatusId",
                        column: x => x.PanelStatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PanelStatuses_ClientId",
                table: "PanelStatuses",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_PanelStatuses_ManagerId",
                table: "PanelStatuses",
                column: "ManagerId");
        }
